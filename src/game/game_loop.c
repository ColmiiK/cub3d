...
{
	mlx_image_to_window(data->mlx, t->i_sprite[0], W_WIDTH / 2, W_HEIGHT / 2);
	mlx_image_to_window(data->mlx, t->i_sprite[1], W_WIDTH / 2, W_HEIGHT / 2);
	mlx_image_to_window(data->mlx, t->i_sprite[2], W_WIDTH / 2, W_HEIGHT / 2);
	mlx_image_to_window(data->mlx, t->i_sprite[3], W_WIDTH / 2, W_HEIGHT / 2);
	mlx_image_to_window(data->mlx, t->i_sprite[4], W_WIDTH / 2, W_HEIGHT / 2);
